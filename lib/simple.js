    ...
    async value(jid, button, rows, quoted, options = {}) {
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'Powered By Alba', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363198641161536@newsletter", "120363198641161536@newsletter", "120363198641161536@newsletter", "120363198641161536@newsletter", "120363198641161536@newsletter"]
let canalNombre = ["Powered By Alba", "Powered By Alba", "Powered By Alba", "Powered By Alba", "Powered By Alba"]
