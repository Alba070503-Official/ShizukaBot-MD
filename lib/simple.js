	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'Momo AyaseBot-MD Powered @Alba070503', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363198641161536@newsletter", "120363198641161536@newsletter", "120363305941657414@newsletter", "120363305941657414@newsletter", "120363301598733462@newsletter"]
let canalNombre = ["Momo AyaseBot-MD Powered @Alba070503🍁", "Canal Official Alba070503 Dev", "🌼Canal de Momo AyaseBot-MD-Test🌼", "All Rights Reserved @Alba070503", "Sky Ultra Plus ☁️"]
