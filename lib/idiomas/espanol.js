...
//main.js
const smsWelcome = () => { return '*┌─★ *ShizukaBot-MD*\n *│「 Bienvenido 🎉」*\n└┬★ 「 @user 」* \n *│✑  Al Grupo @subject *\n *│✑ By @Alba07503* \n*└───────────────┈ ⳹*'}
const smsBye = () => { return '*┌─★ *ShizukaBot-MD*\n  *│「 ADIOS 👋 」*\n└┬★ 「 @user 」* \n *│✑  Se fue*\n *│✑ Hasta Luego* \n*└───────────────┈ ⳹*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'ShizukaBot-Md | By @Alba070503'} 
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, Disfruta de ShizukaBot-MD!!! 😸\n\n💖 ShizukaBot-MD Fue invitado por:\n@${user}`}
...
const smsContacto4 = () => { return 'Contacto Oficial de ShizukaBot ⛩️'}
