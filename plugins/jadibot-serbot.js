...
if (methodCode && !conn.authState.creds.registered) {
    ...
    setTimeout(async () => {
        ...
        conn.sendButton(m.chat, `➩ Code:\` *${codeBot}*\n aqui tienes el codigo`,  'Usen con responsabilidad SpaceNigth Team No se hace responsable de suspensión de cuentas', 'https://i.ibb.co/SKKdvRb/code.jpg', [], codeBot, null, m)   
