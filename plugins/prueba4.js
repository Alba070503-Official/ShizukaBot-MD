...
await conn.sendList(m.chat, '╭═══〘 ✯✯✯✯✯✯✯✯✯ 〙══╮/n/n ║🥀 *𝗛ola, %name Bienvenido al menu* /n/n ║≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡║║🥀 *Owner:* *Alba070503* /n/n ║🥀 *Fecha:* %date /n/n ║🥀 *Tiempo activo:* %uptime /n/n ║🥀 *Versión Actual:* *1.4* /n/n ╰═══╡✯✯✯✯✯✯✯✯✯╞═══╯', null, `Selecione la opción correcta (⁠・⁠∀⁠・⁠)`, listSections, { mentions: [m.sender]}, {quoted: m})
  } catch (e) {
