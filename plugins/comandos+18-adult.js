...
let enlace = await vid[Math.floor(Math.random() * vid.length)] 
let enlace1 = await vid2[Math.floor(Math.random() * vid2.length)] 
let enlace2 = await vidlesbi[Math.floor(Math.random() * vidlesbi.length)] 
let enlace3 = await vidgay[Math.floor(Math.random() * vidgay.length)] 
let enlace4 = await vidbisexual[Math.floor(Math.random() * vidbisexual.length)] 
let enlace5 = await vidrandom[Math.floor(Math.random() * vidrandom.length)] 
...
//await conn.sendButton(m.chat, lenguajeGB.smsCont18PornP(), `*_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[lenguajeGB.smsSigPrem(), `${usedPrefix + command}`], [`🥵 ${lenguajeGB.lenguaje() == 'es' ? ' vid 2' : ' vid 2'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'vid2' : 'vid2'}`]], m, frep) 
break  
    
case "vid2": case "vid2":    
await conn.sendFile(m.chat, enlace1, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, lenguajeGB.smsCont18PornP(), `*_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace1, [[lenguajeGB.smsSigPrem(), `${usedPrefix + command}`], [`🥵 ${lenguajeGB.lenguaje() == 'es' ? ' vid random' : ' vid random'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'vidrandom' : 'vidrandom'}`]], m, frep) 
break 

case "vidlesbi": case "vidlesbi":       
...
case "vidbisexual": case "vidbisexual":       
...
case "vidrandom": case "vidrandom":       
await conn.sendFile(m.chat, enlace5, null, `${lenguajeGB['smsCont18Porn']()}\n${lenguajeGB['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, lenguajeGB.smsCont18PornP(), `*_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace5, [[lenguajeGB.smsSigPrem(), `${usedPrefix + command}`], [`🥵 ${lenguajeGB.lenguaje() == 'es' ? ' vid' : ' vid'} 🥵`.toUpperCase(), `${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'vid' : 'vid'}`]], m, frep)  
break 
...
handler.command = ['vid', 'vid', 'vid2', 'vid2', 'vidlesbi', 'vidlesbi', 'vidgay', 'vidgay', 'vidbisexual', 'vidbisexual', 'vidrandom', 'vidrandom']
