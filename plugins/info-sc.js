...
const handler = async (m, { conn, args }) => {
   const res = await fetch('https://api.github.com/repos/Alba070503-Official/ShizukaBot-MD');
   ...
   await conn.sendMessage(m.chat, {text: txt.trim(), mentions: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: {forwardingScore: 9999999, isForwarded: true, mentionedJid: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title": `ShizukaBot-MD By @Alba070503`, "containsAutoReply": true, "mediaType": 1, "thumbnail": `https://telegra.ph/file/51c6cb59ec0d4b5c7b8d0.jpg`, "mediaUrl": `https://github.com/Alba070503-Official/ShizukaBot-MD`, "sourceUrl": `https://github.com/Alba070503-Official/ShizukaBot-MD`}}}, {quoted: fkontak});
};
handler.help = ['scbot'];
handler.tags = ['info'];
