...
await conn.sendMessage(ch, { text: `🚩 ShizukaBot ha cambiando la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
...
await conn.sendMessage(ch, { text: `🚩 ShizukaBot ha eliminado la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "【 🔔 Notificación General 🔔 】",
...
await conn.sendMessage(ch, { text: `🚩 ShizukaBot ha establecido el modo de reacciones como \`"${mode}"\` para el canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "【 🔔 Notificación General 🔔 】",
...
await conn.sendMessage(ch, { text: `🚩 ShizukaBot ha cambiado el nombre del canal *${name}*\n\n*Anterior nombre:* ${chtitle}\n*Nuevo nombre:* ${name}`, contextInfo: {
externalAdReply: {
title: "【 🔔 Notificación General 🔔 】",
...
await conn.sendMessage(ch, { text: `🚩 ShizukaBot ha modificado la descripción del canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "【 🔔 Notificación General 🔔 】",
