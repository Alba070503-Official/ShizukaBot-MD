...
let td = `${pickRandom([d1,d2,d3,d4,d5,d6])}`
    ...
    await conn.reply(m.chat, '*Enviando el menu . . .*', fload, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '👋 Hola!!', body: saludo, sourceUrl: 'https://whatsapp.com/channel/0029VaAN15BJP21BYCJ3tH04', thumbnail: await (await fetch(pp)).buffer() }}})
m.react('🦈')     
let menu = `╭────꧁༒DATOS༒꧂────•
├🥀 *Nombre :* ${taguser}
├🥀 *Limite :* ${diamond}
